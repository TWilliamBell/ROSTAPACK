...
%       .setDimensioned(opt_name,r,c)
%           Matrix must have size r by c
%
%       Validate properties:     
%       .setSparse(opt_name)
...
% =========================================================================
    ...
    function setVector(name)
        validateAndSet(                                                 ...
            name,                                                       ...
            @(x) ismatrix(x) && min(size(x)) == 1,                      ...
            'a vector'                                                  );
    end
    ...
    function setDimensioned(name,r,c)
        validateAndSet(                                                 ...
            name,                                                       ...
            @(x) isSize(x,r,c),                                         ...
            sprintf('%d by %d',r,c)                                     );
