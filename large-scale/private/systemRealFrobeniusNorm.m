function obj = systemRealFrobeniusNorm(sys,varargin)
%   systemRealFrobeniusNorm:
...
%       implemented.
%
%       systemRealFrobeniusNorm is an implementation for real spectral
%       value sets, where the perturbations must be real-valued and must be
%       bounded by the Frobenius norm, using an ODE-based update step to
%       approximate the spectral value set abscissa and/or radius, which is
%       used as a subroutine in the extended Hybrid Expansion-Contraction
%       (HEC) algorithm for real-valued perturbations.
...
%       instead.
%
%   See also systemComplexTwoNorm and systemComplexTwoNormODE.
%
%
%   For more details, see [MO16] and [GGMO17]. 
%
%   For comments/bug reports, please visit the ROSTAPACK GitLab webpage:
%   https://gitlab.com/timmitchell/ROSTAPACK
%
%   systemRealFrobeniusNorm.m introduced in ROSTAPACK Version 1.0
%
% =========================================================================
...
% =========================================================================
    ...
    function obj = makeSystemObject()
        ...
        normalize_UV_fn         = @normalizeFroNormUV;
