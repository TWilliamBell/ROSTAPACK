function [s,ind] = sortByModulus(lambda)
%   sortByModulus:
%       Sort complex numbers by modulus and break ties with angles. It
...
%
%   sortByModulus.m introduced in ROSTAPACK Version 1.0
%
% =========================================================================
% |  sortByModulus.m                                                      |
...
% =========================================================================
    ...
    [~,indices]         = sort(abs(lambda),'descend');  % largest modulus
